...
@NoArgsConstructor
@Entity
@Table(name = "store_credit_transaction")
public class StoreCreditTransactionEntity {
    ...
    @JoinColumn(name = "store_credit_account_id", nullable = false)
    private StoreCreditAccountEntity storeCreditAccount;

    @Enumerated(EnumType.STRING)
    @Column(name = "transaction_type", nullable = false, length = 20)
    private StoreCreditTransactionType transactionType;
